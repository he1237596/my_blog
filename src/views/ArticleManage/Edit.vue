	...
	<div style="height: 100%;">
		<el-card class="box-card" :body-style="{padding: '0 16px'}">
			<el-form :model="articleForm" :inline="true" ref='articleForm'>
				...
				<div class="md-wrap">
					<mavon-editor v-bind='params' class="md" v-model='articleForm.content' :boxShadow="false" @save="saveArticle" :ishljs="true" ref=md @change="getContent" @imgAdd="$imgAdd" @imgDel="$imgDel" />

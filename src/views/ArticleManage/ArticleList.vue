  ...
  <div class="main">
    ...
    <div class="tableWrap">
      <el-table :data="tableData" height="100%">
        ...
        <el-table-column prop="title" label="标题" width="320" align="center">
        </el-table-column>
        <el-table-column
          prop="content"
          label="内容"
        ...
        <el-table-column fixed="right" label="操作" width="240" align="center">
          <template slot-scope="scope">
            ...
            <el-button @click="deleteArticle(scope.row)" size="small"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    view(row) {
      ...
      // this.title = '查看'
      // this.visible = true;
      // 路由上配置:id,url上可见(/id),this.$route.params获取
      this.$router.push({
        path: `/article-view/${row.id}`
      });
      // 路由不用配置,,url上可见(/id)this.$route.params获取
      // this.$router.push({
      //   name: "articleView",
      //   query: {
      //     id: row.id

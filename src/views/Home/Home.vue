		...
		<el-container>
			<el-header style="text-align: right; font-size: 12px">
				<div>
					...
					<h1>蘑菇物联综合管理系统</h1>
					<el-menu router :default-active="activeIndex2" class="el-menu-demo" mode="horizontal" @select="handleSelect" background-color="#409EFF" text-color="#fff" active-text-color="#ffd04b">
				...
				<div class="right-top">
					<el-dropdown @command="handleCommand">
					    ...
					    {{userInfo.nickname||'用户昵称'}}<i class="el-icon-arrow-down el-icon--right"></i>
					  </span>
			...
			<el-container>
				<el-aside width="200px" style="background-color: #373d41">
					<el-menu :default-active="activeIndex" router class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
						<el-submenu index="1">
							<template slot="title">
